...
namespace O2S_StudentManagement.DAL
{
    ...
    {
        private static O2S_StudentManagement.DAL.ConnectDatabase condb = new O2S_StudentManagement.DAL.ConnectDatabase();
        ...
        private static bool CreateTableTblUser()
        {
            ...
            try
            {
                string sql_tbllog = "CREATE TABLE IF NOT EXISTS SM_TBLUSER ( userid serial NOT NULL, usercode text NOT NULL, username text, userpassword text, userstatus integer, usergnhom integer, usernote text, userhisid integer, CONSTRAINT SM_TBLUSER_pkey PRIMARY KEY (userid) );";
        ...
        private static bool CreateTableTblLog()
        {
            ...
            try
            {
                string sql_tbllog = "CREATE TABLE IF NOT EXISTS SM_TBLLOG ( logid serial NOT NULL, loguser text, logvalue text, ipaddress text, computername text, softversion text, logtime timestamp without time zone, CONSTRAINT SM_TBLLOG_pkey PRIMARY KEY (logid) );";
                if (condb.ExecuteNonQuery_HSBA(sql_tbllog))
                {
                    result = true;
                }
        ...
        private static bool CreateTableOption()
        {
            ...
            try
            {
                string sqloption = "CREATE TABLE IF NOT EXISTS SM_OPTION ( optionid serial NOT NULL, optioncode text, optionname text, optionvalue text, optionnote text, optionlook integer, optiondate timestamp without time zone, optioncreateuser text, CONSTRAINT SM_OPTION_pkey PRIMARY KEY (optionid) );";
        ...
        private static bool CreateTableUserDepartmentgroup()
        {
            ...
            try
            {
                string sqloption = "CREATE TABLE IF NOT EXISTS SM_TBLUSER_departmentgroup(userdepgid serial NOT NULL, departmentgroupid integer, departmentid integer, departmenttype integer, usercode text,  userdepgidnote text, CONSTRAINT tbluser_departmentgroup_pkey PRIMARY KEY (userdepgid));";
                if (condb.ExecuteNonQuery_HSBA(sqloption))
                {
                    result = true;
                }
        ...
        private static bool CreateTableVersion()
        {
            ...
            try
            {
                string sqloption = "CREATE TABLE IF NOT EXISTS SM_VERSION ( versionid serial NOT NULL, appversion text, app_link text, app_type integer, updateapp bytea, appsize integer, sqlversion text, updatesql bytea, sqlsize integer, sync_flag integer, update_flag integer, CONSTRAINT SM_VERSION_pkey PRIMARY KEY (versionid) );";
                if (condb.ExecuteNonQuery_HSBA(sqloption))
                {
                    result = true;
                }
        ...
        private static bool CreateTableLicense()
        {
            ...
            try
            {
                string sql_tbl_license = "CREATE TABLE IF NOT EXISTS SM_LICENSE ( licenseid serial NOT NULL, datakey text, licensekey text, CONSTRAINT SM_LICENSE_pkey PRIMARY KEY (licenseid) );";
        ...
        private static bool CreateTableTblPermission()
        {
            ...
            try
            {
                string sql_tblper = "CREATE TABLE IF NOT EXISTS SM_TBLUSER_PERMISSION ( userpermissionid serial NOT NULL, permissionid integer, permissioncode text, permissionname text, userid integer, usercode text, permissioncheck boolean, userpermissionnote text, CONSTRAINT userpermissionid_pkey PRIMARY KEY (userpermissionid) );";
        ...
        private static bool CreateTableUserMedicineStore()
        {
            ...
            try
            {
                string sql_tbluser = "CREATE TABLE IF NOT EXISTS SM_TBLUSER_medicinestore( usermestid serial NOT NULL, medicinestoreid integer, medicinestoretype integer, usercode text, userdepgidnote text, CONSTRAINT SM_TBLUSER_medicinestore_pkey PRIMARY KEY (usermestid) );";
        ...
        private static bool CreateTableUserMedicinePhongLuu()
        {
            ...
            try
            {
                string sql_tbluser = "CREATE TABLE IF NOT EXISTS SM_TBLUSER_medicinephongluu( userphongluutid serial NOT NULL, medicinephongluuid integer, medicinestoreid integer, usercode text, userdepgidnote text, CONSTRAINT SM_TBLUSER_medicinephongluu_pkey PRIMARY KEY (userphongluutid) );";
                if (condb.ExecuteNonQuery_HSBA(sql_tbluser))
                {
                    result = true;
                }
        ...
        private static bool CreateTableConfig()
        {
            ...
            try
            {
                string sqloption = "CREATE TABLE IF NOT EXISTS cp_config ( configid serial NOT NULL, usergdbhyt text, passgdbhyt text, urlfullserver text, configtype integer, CONSTRAINT cp_config_pkey PRIMARY KEY (configid) );";
                if (condb.ExecuteNonQuery_HSBA(sqloption))
                {
                    result = true;
                }
