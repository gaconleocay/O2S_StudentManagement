...
namespace O2S_StudentManagement.Base
{
    public static class ThongBaoLable
    {
        ...
        internal static string THEM_MOI_THAT_BAI = "Thêm mới thất bại!";
        ...
        internal static string DA_CHAY_XONG_GIAM_DINH = "Đã chạy xong giám định!";
        internal static string CAP_NHAT_THAT_BAI = "Cập nhật thất bại!";
        internal static string THAO_TAC_THAT_BAI = "Thao tác thất bại!";

        internal static string CHUA_NHAP_MA_BENH_NHAN = "Chưa nhập mã bệnh nhân!";
        internal static string CHUA_TAG_THE_GUI_XE = "Chưa tag thẻ gửi xe!";
        internal static string CHUA_TAG_THE_GUI_XE_VA_QUET_MA_BENH_NHAN = "Chưa tag thẻ gửi xe và quét mã bệnh nhân!";
        internal static string SAI_MA_BENH_NHAN = "Sai mã bệnh nhân!";
