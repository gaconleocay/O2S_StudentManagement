...
namespace O2S_StudentManagement.Utilities.Common.Excel
{
    public class ExcelExport
    {
        ...
        private DataTable InsertOrders(List<Model.Models.reportExcelDTO> thongTinThem)
        {
            ...
            {
                O2S_StudentManagement.Common.Logging.LogSystem.Error(ex);
            }
            return orderTable;
        }
                    ...
                    if (saveDialog.ShowDialog() != DialogResult.Cancel)
                    {
                        ...
                        if (File.Exists(fileTemplatePath))
                        {
                            ...
                            if (dataExportExcel.Tables.Count > 0)
                            {
                                ...
                                O2S_StudentManagement.Utilities.ThongBao.frmThongBao frmthongbao = new O2S_StudentManagement.Utilities.ThongBao.frmThongBao(O2S_StudentManagement.Base.ThongBaoLable.EXPORT_DU_LIEU_THANH_CONG);
                                frmthongbao.Show();
                            }
                        }
                        else
                        {
                            O2S_StudentManagement.Utilities.ThongBao.frmThongBao frmthongbao = new O2S_StudentManagement.Utilities.ThongBao.frmThongBao(O2S_StudentManagement.Base.ThongBaoLable.KHONG_TIM_THAY_TEMPLATE_BAO_CAO);
                            frmthongbao.Show();
                        }
                    }
                }
