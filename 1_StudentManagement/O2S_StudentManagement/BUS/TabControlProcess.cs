...
using O2S_StudentManagement.GUI.MenuTrangChu;
using System;
        ...
        internal static UserControl SelectUCControlActive(string ucName)
        {
            ...
            try
            {
                switch (ucName)
                {
                    ...
                    //    break;
                    //case "REPORT_02":
                    //    ucResult = new GUI.MenuBaoCao.ucBCTaiChinhGiaoDich_TongHop();
                    //    break;
                    //case "REPORT_03":
                    //    ucResult = new GUI.MenuBaoCao.ucBCTinhHinh_TongHop();
                    //    break;
                    //case "REPORT_04":
                    //    ucResult = new GUI.MenuBaoCao.ucBCDSTheXeNoiTru();
                    //    break;
                    //case "REPORT_05":
                    //    ucResult = new GUI.MenuBaoCao.ucBCMatTheGuiXe();
                    //    break;
                    //case "REPORT_06":
                    //    ucResult = new GUI.MenuBaoCao.ucBCXeNamLauTrongBai();
                    //    break;
