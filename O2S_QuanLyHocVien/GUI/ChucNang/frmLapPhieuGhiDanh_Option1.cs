...
// File "frmLapPhieuGhiDanh_Option1.cs"
...
{
    public partial class frmLapPhieuGhiDanh_Option1 : Form
    {
        #region Khai bao
        ...
        public frmLapPhieuGhiDanh_Option1()
        {
            InitializeComponent();
        }

        #region Load
        private void frmLapPhieuGhiDanh_Option1_Load(object sender, EventArgs e)
        {
            try
            {
