                    ...
                    if (saveDialog.ShowDialog() != DialogResult.Cancel)
                    {
                        ...
                        if (File.Exists(fileTemplatePath))
                        {
                            ...
                            if (dataExportExcel.Tables.Count > 0)
                            {
                                ...
                                O2S_QuanLyHocVien.Utilities.ThongBao.frmThongBao frmthongbao = new O2S_QuanLyHocVien.Utilities.ThongBao.frmThongBao(O2S_QuanLyHocVien.Base.ThongBaoLable.EXPORT_DU_LIEU_THANH_CONG);
                                frmthongbao.Show();
                            }
                        }
                        else
                        {
                            O2S_QuanLyHocVien.Utilities.ThongBao.frmThongBao frmthongbao = new O2S_QuanLyHocVien.Utilities.ThongBao.frmThongBao(O2S_QuanLyHocVien.Base.ThongBaoLable.KHONG_TIM_THAY_TEMPLATE_BAO_CAO);
                            frmthongbao.Show();
                        }
                    }
                }
