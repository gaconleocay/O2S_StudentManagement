        ...
        private void TaoCot_DataGridView(List<LopHoc_PlusDTO> _lstLopHoc)
        {
            try
            {
                foreach (var item_lh in _lstLopHoc)
                {
                    ...
                    this.bandedGridViewDataBC.Columns.AddRange(new DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn[] { gridColumnLop_0_ca, gridColumnLop_0_gvchinh, gridColumnLop_0_gvtrogiang });
                    //=================
